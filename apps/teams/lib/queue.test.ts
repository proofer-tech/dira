...
test("planOf — 문장이 길어 다음 줄로 접힌 항목도 창을 잡는다(§2-11① 요구 29a9f060)", () => {
  const body =
    "## 진행 계획\n\n" +
    "- [x] 아주 긴 문장이 있어서\n" +
    "  줄이 접혔다 (2026-08-18T09:12:03+09:00 -> 2026-08-18T09:40:11+09:00)\n";
  assert.deepStrictEqual(planOf(body), [
    {
      text: "아주 긴 문장이 있어서 줄이 접혔다",
      state: "done",
      start: "2026-08-18T09:12:03+09:00",
      end: "2026-08-18T09:40:11+09:00",
    },
...
test("planOf — 끝이 괄호 밖에 붙어도 종전 정본 모양과 같은 start/end로 읽힌다(§2-11① 요구 29a9f060)", () => {
  const body =
    "## 진행 계획\n\n- [x] 문장 (2026-08-18T09:12:03+09:00) -> 2026-08-18T09:40:11+09:00\n";
  assert.deepStrictEqual(planOf(body), [
    {
      text: "문장",
      state: "done",
...
test("planOf — 괄호 뒤 꼬리말은 문장의 일부로 남는다(§2-11① 요구 29a9f060)", () => {
  const body =
    "## 진행 계획\n\n" +
    "- [x] 문장 (2026-08-18T09:12:03+09:00 -> 2026-08-18T09:40:11+09:00) 꼬리말\n";
  assert.deepStrictEqual(planOf(body), [
    {
      text: "문장 꼬리말",
      state: "done",
 ...
 *  이라 떼인다 — **제목 문자열로 안 고른다**(결정 12 고정하는 것). 둘을 합치면 원문과 같다. */
