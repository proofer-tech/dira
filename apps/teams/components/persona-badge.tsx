 ...
 *  페르소나 색은 뜻이 없는 신원 표식이고 상태 색은 뜻이 정해져 있다 — 섞으면 사람이 고른 초록이
 ...
 *  모션 값은 §비주얼 §18(`--animate-wip-pulse`)이고 `motion-reduce`에서 기본 상태에 뜬다 —
 *  움직임이 사라져도 레인·상태 배지·워커 이름이 `진행중`을 글자로 알려 준다. */
 ...
 *  상태 컬럼과 persona 컬럼이 이웃이라 회색으로 채운 배지 두 개가 나란히 놓인다.
