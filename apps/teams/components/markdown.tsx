/** 읽기 전용 마크다운 렌더 (DESIGN.md §비주얼 §10). 붙는 곳은 셋 — 요구사항 왕복 스레드,
 *  `.wip` 티켓 본문, 페르소나 카드의 메모리 전문(§5-2 · §32). **세 자리가 같은 값을 쓴다**:
 *  §10 표가 유일한 출처고 자리별 오버라이드가 없다. 편집기(본문 폼 · 페르소나 · 프로토콜)는 종전대로 원문이다.
 *
